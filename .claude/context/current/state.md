...
**Last Updated:** 2025-11-24 12:30 (session append)
**Last /clear:** 2025-11-23 03:00
**Last /save:** 2025-11-24 12:30
**Token Count:** ~12k tokens (pre-curation)
...
- log_Days main effect: β=-0.47, p<.001 (memory decline)

**Post-hoc Contrasts (Bonferroni α=0.0167):**
| Comparison | β | z | p (corrected) | Significant |
|------------|---|---|---------------|-------------|
