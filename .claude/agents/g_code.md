...
# =============================================================================
# - data/   : ALL data files (.csv, .pkl) - inputs and outputs
# - logs/   : ALL log files (.log) - execution logs
# - code/   : ALL Python scripts (.py) - generated by g_code
# - results/: Summary outputs (model comparisons, reports)
