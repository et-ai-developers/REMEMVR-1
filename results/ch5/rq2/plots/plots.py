...
# -*- coding: utf-8 -*-
"""
Plotting script for RQ 5.2 - Differential Consolidation Across Memory Domains
...
# Get absolute path to RQ root (plots.py is in results/ch5/rq2/plots/)
...
print("=" * 70)
print("RQ 5.2 PLOTTING: Differential Consolidation Across Memory Domains")
print("=" * 70)
