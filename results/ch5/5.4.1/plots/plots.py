...
# -*- coding: utf-8 -*-
"""
Plotting script for RQ 5.5 - Schema Congruence Effects on Forgetting Trajectories
...
# Get absolute path to RQ root (plots.py is in results/ch5/rq5/plots/)
...
print("=" * 70)
print("PLOTTING FOR RQ 5.5: Schema Congruence Effects on Forgetting")
print("=" * 70)
