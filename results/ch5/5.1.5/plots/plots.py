...
- This script ONLY reads CSVs and calls matplotlib (no scatter function in tools/plotting.py)
...
# Define cluster colors (3 clusters for current analysis)
cluster_colors = {
    0: '#E74C3C',  # Red (REMEMVR What domain color)
    1: '#3498DB',  # Blue (REMEMVR Where domain color)
    2: '#2ECC71'   # Green (REMEMVR When domain color)
}
...
print(f"  [PASS] Saved: plots/cluster_scatter.png")
