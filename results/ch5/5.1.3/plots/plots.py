...
# -*- coding: utf-8 -*-
"""
Plotting script for RQ 5.9 - Age Effects on Baseline Memory and Forgetting Rate
...
# plots.py is in results/ch5/rq9/plots/ (parents: [3]=results, [4]=REMEMVR)
...
ax.set_title('RQ 5.9: Age Effects on Memory Trajectory', fontweight='bold', pad=15)
