...
# -*- coding: utf-8 -*-
"""
Plotting script for RQ 5.8 - Evidence for Two-Phase Forgetting (Rapid then Slow)
...
print("Starting plotting for RQ 5.8...")
...
fig.suptitle('RQ 5.8: Two-Phase Forgetting - Model Comparison',
