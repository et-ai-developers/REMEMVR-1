...
**Purpose:** Fit Theta ~ Time + Time� + (Time | UID), test if Time� coefficient is positive and significant (p < 0.003333 Bonferroni-corrected)
...
4. **Test quadratic term significance:**
   - Bonferroni-corrected threshold: � = 0.05 / 15 = 0.003333 (15 RQs in Chapter 5)
