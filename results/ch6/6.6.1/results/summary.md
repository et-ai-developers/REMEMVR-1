...
- p_wald (REML): 0.000021 (p < .001) ✓
- p_lrt (ML LRT): 0.000040 (p < .001) ✓
- Significant: **True** (both p-values < 0.05)

**Sensitivity Analysis (Step 05):**
- Model A (Full, random slopes): β=-0.003, p<.001 ✓
- Model B (Intercepts only): β=-0.003, p<.001 ✓
- Model C (Quadratic): Days² NOT significant (p=0.608)
- Model D (Exclude late): β=-0.003, p<.001 ✓
