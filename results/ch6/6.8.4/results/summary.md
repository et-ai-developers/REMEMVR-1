...
**Interpretation:** 75% of participant-sessions show adequate rating variability (SD â‰¥ 0.20). The 25% with restricted range may contribute to lower clustering quality (Silhouette = 0.33) by adding measurement noise to random effects. However, no systematic extreme response bias detected (0% using only endpoints).
