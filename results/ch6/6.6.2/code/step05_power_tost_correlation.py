...
coeffs = pd.read_csv('data/step03_regression_coefficients.csv')
...
effect_sizes = pd.read_csv('data/step04_effect_sizes.csv')
...
power_results.to_csv('data/step05_power_analysis.csv', index=False)
...
tost_results.to_csv('data/step05_tost_equivalence.csv', index=False)
...
data = pd.read_csv('data/step00_predictor_data.csv')
...
correlation_results.to_csv('data/step05_correlation_confidence_accuracy.csv', index=False)
