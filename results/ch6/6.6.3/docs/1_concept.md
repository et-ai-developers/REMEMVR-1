...
- Strategy: (1) Attempt full model (Time | UID), (2) If singular fit or non-convergence, use LRT to compare: (Time | UID) vs (1 | UID), (3) If variance component ≈ 0, proceed with intercept-only random effects
...
- Use emmeans contrasts with Bonferroni correction (α = 0.05/3 = 0.017) or Tukey HSD
