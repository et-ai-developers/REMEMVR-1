...
**Step 1:** Compute calibration per paradigm: Calibration = theta_confidence - theta_accuracy (both z-standardized first for comparable scales)

**Step 2:** Fit LMM with Paradigm × Time interaction: `Calibration ~ Paradigm × Time + (Time | UID)`, test Paradigm main effect and interaction
