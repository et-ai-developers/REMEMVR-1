...
def main():
    ...
    ch5_files = [
        ("Overall (5.1.1)", "/home/etai/projects/REMEMVR/results/ch5/5.1.1/data/step03_theta_scores.csv", ["UID", "theta_all"]),
        ("What domain (5.2.1)", "/home/etai/projects/REMEMVR/results/ch5/5.2.1/data/step03_theta_scores.csv", ["UID"]),  # Column names vary
        ("Where domain (5.2.2)", "/home/etai/projects/REMEMVR/results/ch5/5.2.2/data/step03_theta_scores.csv", ["UID"]),
        ("When domain (5.2.3)", "/home/etai/projects/REMEMVR/results/ch5/5.2.3/data/step03_theta_scores.csv", ["UID"]),
    ]
