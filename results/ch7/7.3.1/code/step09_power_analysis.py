...
try:
    ...
    n = len(df)
    k = 6  # Number of predictors (age, sex, education, RAVLT_T, BVMT_T, RPM_T)
    ...
    alpha_bonferroni = 0.00179 / 3  # 0.000597 for cognitive tests
    power_target = 0.80
    ...
    cognitive_tests = ['RAVLT_T', 'BVMT_T', 'RPM_T']
