...
if __name__ == "__main__":
    try:
        ...
        required_cols = ['confidence_theta', 'age', 'sex', 'education', 'RAVLT_T', 'BVMT_T', 'RPM_T']
        ...
        X = df_analysis[['age', 'sex', 'education', 'RAVLT_T', 'BVMT_T', 'RPM_T']]
        ...
        n_tests = 3  # Three cognitive tests: RAVLT_T, BVMT_T, RPM_T
        alpha_bonferroni = 0.00179 / n_tests  # = 0.000597
...
"""
        ...
        n_significant_cognitive = sum(individual_df[individual_df['predictor'].isin(['RAVLT_T', 'BVMT_T', 'RPM_T'])]['p_bonferroni'] < alpha_bonferroni)
        max_vif = max(vif_values)
        
        log(f"[VALIDATION] Predictors with p_bonferroni < 0.05: {n_significant_bonferroni}/6")
        log(f"[VALIDATION] Cognitive tests with p < {alpha_bonferroni:.6f}: {n_significant_cognitive}/3")
