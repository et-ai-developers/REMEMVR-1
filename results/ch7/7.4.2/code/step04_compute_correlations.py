...
- results/ch7/7.4.2/data/step04_correlations.csv
  ...
  Expected rows: 2 correlations (BVMT_Where, BVMT_What)
...
if __name__ == "__main__":
    try:
        ...
        expected_cols = ["UID", "bvmt_total", "Where_mean", "What_mean"]
        ...
        correlations_to_compute = [
            {
                ...
                'x_var': 'bvmt_total', 
                'y_var': 'Where_mean',
                'description': 'Correlation between visuospatial memory and Where domain'
            },
            {
                'name': 'BVMT_What', 
                'x_var': 'bvmt_total', 
                'y_var': 'What_mean',
                'description': 'Correlation between visuospatial memory and What domain'
            }
        ]
