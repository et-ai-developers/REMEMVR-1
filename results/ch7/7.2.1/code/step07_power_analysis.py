...
if __name__ == "__main__":
    try:
        ...
        n = 100  # Sample size
        k = 4    # Number of predictors in Model 2 (Age + 3 cognitive tests)
        alpha = 0.0125  # Bonferroni corrected alpha (0.05/4)
        ...
        k_added = 3  # Number of predictors added in Model 2
