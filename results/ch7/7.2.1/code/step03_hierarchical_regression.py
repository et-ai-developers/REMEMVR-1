...
if __name__ == "__main__":
    try:
        ...
        X_block2 = analysis_df[['RAVLT_T_std', 'BVMT_T_std', 'RPM_T_std']]
        
        log(f"[DATA] Response variable: theta_all (n={len(y)})")
        log(f"[DATA] Model 1 predictors: Age_std")
        log(f"[DATA] Model 2 additional predictors: RAVLT_T_std, BVMT_T_std, RPM_T_std")
        ...
        alpha_bonferroni = 0.0125  # Bonferroni correction: 0.05/4 predictors
