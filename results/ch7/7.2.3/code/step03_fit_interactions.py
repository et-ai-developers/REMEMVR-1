...
BONFERRONI_ALPHA = 0.05 / 4  # 4 interaction tests
...
def fit_interaction_model(df, test_name):
    ...
    interaction_p_bonf = min(1.0, interaction_p_uncorr * 4)  # Bonferroni correction
...
def main():
    ...
    print(f"  α = 0.05 / 4 tests = {BONFERRONI_ALPHA:.4f}")
    print("=" * 60)
    ...
    if significant_interactions:
        ...
        print("All Age x Test interactions p > 0.0125 (Bonferroni-corrected)")
