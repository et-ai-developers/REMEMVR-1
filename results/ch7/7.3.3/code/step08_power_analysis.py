...
if __name__ == "__main__":
    try:
        ...
        n = 100  # Sample size
        n_predictors = 6  # Full model predictors (age_c, sex, education, ravlt_c, bvmt_c, rpm_c)
        n_cognitive = 3  # Cognitive predictors (ravlt_c, bvmt_c, rpm_c)
        ...
        for predictor in ['ravlt_c', 'bvmt_c', 'rpm_c']:
